...
const Chart = (props) => {
  ...
  const data = {
      datasets: [
        ...
        {
          label: lang[language]['Hardware Value'],
        ...
        {
          label: lang[language]['Net Profit/Loss (Cumulative)'],
        ...
        {
          label: lang[language]['Revenue per month'],
        ...
        {
          label: lang[language]['Net profit per month'],
        ...
        xAxes: [
          {
            ...
            scaleLabel: {
              display: true,
              labelString: lang[language]['Time Period'],
        ...
        yAxes: [
          {
            ...
            scaleLabel: {
              display: true,
              labelString: lang[language]['Monthly Revenue'],
              fontSize: matches? 8: 14,
              fontColor: 'white'
              // fontFamily: 'sans-serif',
            },
          ...
          },
          {
            ...
            scaleLabel: {
              display: true,
              labelString: lang[language]['Cumulative Profit and Cash Flow'],
              fontSize: matches? 8: 14,
              fontColor: 'white',
    ...
    return (
      <div className={classes.chartWrap} onMouseOver={(e) => chartMouseHandler(true)} onMouseLeave={(e) => chartMouseHandler(false)}>
        ...
        <h4 className={classes.title}>
          {lang[language]['Revenue and Profit Calculator']}
        </h4>
        <Bar
          data={data}
          options={options}
